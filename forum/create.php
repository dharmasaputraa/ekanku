        ...
        <div class="container">
            <div class="card">
                <div class="card-body d-flex align-items-center item justify-content-between">
                    <span class="h5">Ajukan Pertanyaan</span>
                    ...
                    <form action="forum-proses.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="date" name="date" class="form-control" placeholder="Masukkan date" required />
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <textarea class="form-control" type="text" name="detail" style="height: 20vh;" required></textarea>
                            </div>
                        </div>
