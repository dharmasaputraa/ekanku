...
$query = "SELECT * FROM forum LEFT JOIN user ON user.id = forum.user WHERE parent_comment = 0;";
                ...
                <div class="pt-5 mx-2">
                    <div class="card p-0">
                        <div class="d-flex align-items-center justify-content-between py-3 px-4">
                            <div>
                                <span class="text-dark heading fs-5">Semua Pertanyaan</span>
                                <p class="p-0 m-0"><?= $hitung ?> pertanyaan</p>
                            </div>
                            <a href="forum/create.php" class="btn-bs-primary py-2 fw-bold"><i class="uil uil-comment-alt-plus fs-5 me-2"></i>Ajukan Pertanyaan</a>
                        </div>
                    </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between pt-4 px-4">
                                <div class="border-bottom vw-100">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <a href="forum-page.php?forum=<?= $result['id_forum']; ?>" class="fw-bold fs-5"><span><?= $result['title']; ?></span></a>
                                        <?php if ($result['nickname'] == $_SESSION['nama']) { ?>
                                            <div>
                                    ...
                                    <p class="p-0 m-0 pt-2 subheading">
                                        <?= $result['detail']; ?>
                                    </p>
                                    <div class="d-flex align-items-center justify-content-between my-4">
                                        <p class="mb-0 subheading">
                                            <i class="uil uil-user me-1"></i><?= $result['nickname']; ?>, <?= $result['date']; ?>
                                        </p>
