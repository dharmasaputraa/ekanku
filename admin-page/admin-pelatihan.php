...
<body id="body-pd" class="body-pd  bg-light">
    ...
    <div class="hw-80">
        <div class="container-admin">
            <span class="fw-bold fs-5">Pelatihan</span>
            <div class="card mt-3">
                <div class="card-body d-flex align-items-center justify-content-between">
                    <a href="pelatihan-admin/create.php" class="btn-bs-primary"><i class="uil-plus-circle me-2"></i>Add Pelatihan</a>
                </div>
                    ...
                    <table class="table table-bordered table-striped align-middle">
                        <thead class="">
                            <tr>
                                ...
                                <th scope="col" class="ps-3">Judul Pelatihan</th>
                                <th scope="col" class="ps-3">Perusahaan</th>
                                <th scope="col" class="ps-3">Open Pendaftaran</th>
                                <th scope="col" class="ps-3">Close Pendaftaran</th>
                                <th scope="col" class="ps-3">Buka?</th>
                                <th scope="col" class="ps-3">Kuota</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <th scope="row" class="ps-3"><?= $result['id_pelatihan']; ?></th>
                                    <td class="ps-3"><?= $result['img_pelatihan']; ?></td>
                                    <td class="ps-3"><?= $result['title_pelatihan']; ?></td>
                                    <td class="ps-3"><?= $result['nama_perusahaan']; ?></td>
                                    <td class="ps-3"><?= $result['open_registrasi']; ?></td>
                                    <td class="ps-3"><?= $result['close_registrasi']; ?></td>
                                    <td class="ps-3"><?= $result['buka']; ?></td>
                                    <td class="ps-3"><?= $result['kuota']; ?></td>
                                    <td class="d-flex justify-content-evenly">
                                        <a href="pelatihan-admin/edit.php?ubah=<?= $result['id_pelatihan']; ?>" class="fs-5"><i class='uil-edit text-warning'></i></a>
                                        <a href="pelatihan-admin/pelatihan-proses.php?hapus=<?= $result['id_pelatihan']; ?>" type="button" name="hapus" class="fs-5 text-danger" onClick="return confirm('Apakah anda ingin menghapus data ini?')"><i class='uil-trash'></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
